(() => {
  ...
  const STORAGE_KEY = 'indonesiaBank.words.v1';
  let words = loadWords();
    ...
    elements.wordGrid.innerHTML = result.length ? `
      <div class="table-scroll">
        <table class="word-table">
          <thead><tr>
            <th class="number-column">No.</th><th>Kosakata</th><th>Arti</th><th>Catatan</th><th class="date-column">Ditambahkan</th><th class="action-column">Aksi</th>
          </tr></thead>
  ...
  function submitForm(event) {
    ...
    if (duplicate) {
      ...
      showToast('Kosakata yang sama sudah ada di Indonesia Bank.');
      return;
    }
